package com.example.thewitcher3bestiary.ui.Insectoids;
...
public class InsectoidsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.fragment_insectoids, container, false);
            ...
            public void onResponse(Call<Response> call, retrofit2.Response<Response> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    for (ObjectBeast beast : beasts) {
                        if ("Insectoids".equals(beast.getType())) {
