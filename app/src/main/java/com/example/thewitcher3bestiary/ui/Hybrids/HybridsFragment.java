package com.example.thewitcher3bestiary.ui.Hybrids;
...
public class HybridsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.fragment_hybrids, container, false);
            ...
            public void onResponse(Call<Response> call, retrofit2.Response<Response> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    for (ObjectBeast beast : beasts) {
                        if ("Hybrids".equals(beast.getType())) {
